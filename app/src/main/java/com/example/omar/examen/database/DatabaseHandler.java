package com.example.omar.examen.database;
...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    // database name
    protected static final String DATABASE_NAME = "ExamenDatabase1";

    // table details
    public String tableName = "locations";
    public String fieldObjectId = "id";
    public String fieldObjectName = "name";
    public String fieldObjectDescription = "vicinity";
    ...
    public void insertFast(int insertCount) {
        ...
        String sql = "INSERT OR REPLACE INTO " + tableName + " ( name, vicinity ) VALUES ( ?, ? )";
    ...
    public void insertNormal(int insertCount){
        try{
            ...
            for(int x=1; x<=insertCount; x++){
                ...
                values.put(fieldObjectDescription, "Vicinity # " + x);
